...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 130.0, 96.0, 150.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 301.891096322536555, 222.444441020488739, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 258.780742027759572, 222.444441020488739, 24.0, 24.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 161.0, 99.0, 39.0, 23.0 ],
									"rnbo_classname" : "click~",
									"rnbo_serial" : 1,
									"rnbo_uniqueid" : "click~_obj-47",
									"text" : "click~"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 131.0, 58.0, 24.0, 24.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 131.0, 137.0, 49.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 4,
									"numoutlets" : 0,
									"patching_rect" : [ 66.0, 190.0, 110.0, 23.0 ],
									"rnbo_classname" : "poke~",
									"rnbo_extra_attributes" : 									{
										"channelmode" : "ignore",
										"indexmode" : "samples",
...
,
									"rnbo_serial" : 1,
									"rnbo_uniqueid" : "poke~_obj-30",
									"text" : "poke~ delay_buffer"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 103.0, 272.0, 73.0, 23.0 ],
									"rnbo_classname" : "samplerate~",
									"rnbo_serial" : 1,
									"rnbo_uniqueid" : "samplerate~_obj-22",
									"text" : "samplerate~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 66.0, 272.0, 30.0, 23.0 ],
									"rnbo_classname" : "sig~",
									"rnbo_extra_attributes" : 									{
										"unit" : "ms"
									}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 66.0, 313.0, 56.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 66.0, 351.0, 120.0, 23.0 ],
									"rnbo_classname" : "peek~",
									"rnbo_extra_attributes" : 									{
										"channelmode" : "ignore",
										"indexmode" : "samples",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 215.0, 190.0, 148.0, 23.0 ],
									"rnbo_classname" : "data",
									"rnbo_extra_attributes" : 									{
										"fill" : "",
										"file" : "",
...
,
									"text" : "data delay_buffer 48000 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 66.0, 232.0, 28.0, 23.0 ],
									"rnbo_classname" : "in",
									"rnbo_extra_attributes" : 									{
										"meta" : "",
										"comment" : ""
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 66.0, 388.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"meta" : "",
										"comment" : ""
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 66.0, 58.0, 35.0, 23.0 ],
									"rnbo_classname" : "in~",
									"rnbo_extra_attributes" : 									{
										"meta" : "",
										"comment" : ""
...
, 							{
						...
						"export_config" : 						{
							"vst-au-export" : 							{
								"vst-au-export-ins" : 								{
									"plugin_name" : "1 second record test"
								}
...
,
					"patching_rect" : [ 129.780742027759572, 257.851848840713501, 148.0, 22.0 ],
					"rnboattrcache" : 					{
...
,
					"saved_object_attributes" : 					{
						"optimization" : "O1",
						"parameter_enable" : 1,
						"uuid" : "8f800f43-6968-11ee-8f43-2cf05d9a4f15"
					}
,
					"snapshot" : 					{
						...
						"embed" : 1,
						"snapshot" : 						{
							"__presetid" : "8f800f43-6968-11ee-8f43-2cf05d9a4f15"
						}
,
						"snapshotlist" : 						{
							"current_snapshot" : 0,
							"entries" : [ 								{
									...
									"minorversion" : 0,
									"name" : "untitled",
									"origin" : "8f800f43-6968-11ee-8f43-2cf05d9a4f15",
									"type" : "rnbo",
									"subtype" : "",
									"embed" : 0,
									"snapshot" : 									{
...
,
									"fileref" : 									{
										"name" : "untitled",
										"filename" : "untitled_20231012_1.maxsnap",
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "e066d240386f885c3a3566be2a0732e8"
									}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 222.481482088565826, 337.185177147388458, 173.222224116325378, 104.148150503635406 ]
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 139.5, 169.0, 139.5, 169.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 172.5, 166.0, 154.0, 166.0, 154.0, 178.0, 139.5, 178.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "untitled_20231012_1.maxsnap",
